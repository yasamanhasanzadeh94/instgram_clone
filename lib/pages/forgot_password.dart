...
class ForgotPasswordState extends State<ForgotPassword> with SingleTickerProviderStateMixin{
TabController? tabController;
String headerText = "Enter your username or email and we'll \n send you a link to get back into your \n account";
...
tabController = TabController(length: 2, vsync: this);
  ...
  tabController!.addListener(() {
    if(tabController!.index == 0){setState(() {
      headerText = "Enter your username or email and we'll \n send you a link to get back into your \n account";
    });
  }
    else{setState(() {
      headerText = "Enter your phone number and we'll send \n you a login code to get back into your \n account";
    });
    }});
   return GestureDetector(onTap: () => FocusScope.of(context).unfocus(),
     child: DefaultTabController(
       ...
       child: Scaffold(
         ...
         body: Container(
            ...
            height: fullHeight(context),
             child: Column(
              ...
              children: [
               Container(margin: EdgeInsets.only(top: xxlargeSize(context)+standardSize(context)),
                   child: Image.network("https://icon-library.com/images/forgot-password-icon/forgot-password-icon-22.jpg"),
                width:fullWidth(context)/4,height: fullHeight(context)/4,),
               Container(
               ...
               Container(
                   margin: EdgeInsets.symmetric(vertical: xSmallSize(context),horizontal: smallSize(context)),
                 child: TabBar(
                   controller: tabController,
                   tabs: [
                     Text("Username"),Text("Phone")],
                   labelColor: Colors.black,
                 labelPadding: EdgeInsets.symmetric(vertical: smallSize(context)),
                 ...
                 child: TabBarView(
                     ...
                     children:[
                       ...
                       SizedBox(
                         width: fullWidth(context),
                         child:
                         phoneTextField(context, "phoneNumber"),
                       ),
                     ]
                   ),
               ),
        ...
        Expanded(child: SizedBox(height: xxlargeSize(context),)),
        Row(
